  ...
  if (active)
    return (
      <div className="pointer-events-none fixed z-30 h-full w-full">
        <Overlay className="!z-30 bg-black bg-opacity-40" action={() => dismiss()} />
        <div className="pointer-events-auto absolute top-1/2 left-1/2 h-min w-full -translate-x-1/2 -translate-y-1/2 transform bg-white p-8 sm:w-max sm:max-w-[100vw]">
